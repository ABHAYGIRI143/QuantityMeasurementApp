...
public class UnitToUnitConversionTest {
    ...
    void testConversion_FeetToInches(){
        ...
        double result=
                UnitToUnitConversion.QuantityLength.convert(
                        1.0,
                        UnitToUnitConversion.LengthUnit.FEET,
                        UnitToUnitConversion.LengthUnit.INCHES);
    ...
    void testConversion_YardsToInches(){
        ...
        double result=
        		UnitToUnitConversion.QuantityLength.convert(
                        1.0,
                        UnitToUnitConversion.LengthUnit.YARDS,
                        UnitToUnitConversion.LengthUnit.INCHES);
    ...
    void testConversion_CentimetersToInches(){
        ...
        double result=
        		UnitToUnitConversion.QuantityLength.convert(
                        2.54,
                        UnitToUnitConversion.LengthUnit.CENTIMETERS,
                        UnitToUnitConversion.LengthUnit.INCHES);
